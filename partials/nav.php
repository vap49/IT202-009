...
<nav class="navbar navbar-expand-lg navbar-light bg-info">
    <div class="container-fluid">
        <a class="navbar-brand" href="<?php echo get_url('shop.php'); ?>">Bamazon.com</a> 
        ...
        <div class="collapse navbar-collapse" id="navContent">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link" href="<?php echo get_url('order_history.php'); ?>">Orders</a></li>
                <?php if (is_logged_in()) : ?>
                ...
                <?php if (has_role("Admin")) : ?>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu bg-info" aria-labelledby="rolesDropdown">
                            ...
                            <li><a class="dropdown-item" href="<?php echo get_url('Admin/orders.php'); ?>">Orders</a></li>
                            <li><a class="dropdown-item" href="<?php echo get_url('Admin/allProducts.php'); ?>">All Products</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
